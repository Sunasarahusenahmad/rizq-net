      ...
      <main>
        ...
        <section className="our-company-sec mt100 mb100">
          <div className="container">
            <div className="row">
              <div className="xl-10 text-center mx-auto">
                <span className="d-inline-block bg-light px-3 py-2 rounded-3">
                  🤩 What Drives Us
                </span>
                <h1 className="mb20 mt20 company-heading-title">
                  We are an Independent Brand, Design, <br /> and Communication
                  Agency
                </h1>
                <p className="company-desc mb-0">
                  {" "}
                  We are an insight and behaviors driven creative marketing
                  agency. A Full package Digital Creative Agency Specializing
                  in: <br /> Video Production, Web Design, Branding, Brand
                  Strategy, Content Marketing and Aerial Cinematography.{" "}
                </p>
                <div className="row g-4 mt70 mx-auto items-end">
                  <div className="md-5 relative">
                    <img
                      src={`../../../resources/images/about/company-img-1.jpg`}
                      loading="lazy"
                      className="company-img-1 rounded mb30"
                      alt="about-img"
                    />
                    <figure className="absolute top-0 start-0 company-svg-1">
                      <svg
                        width="167"
                        height="107"
                        viewBox="0 0 167 107"
                    ...
                    <div className="text-end relative d-none d-md-block">
                      <figure className="absolute top-0 company-svg-2">
                        <svg width="106px" height="96px" viewBox="0 0 106 96">
                      ...
                      <img
                        src={`../../../resources/images/about/company-img-2.jpg`}
                        loading="lazy"
                        className="rounded mt10 mb20 w-50"
                        alt="about-img"
                      />
                    </div>
                  </div>
                  <div
                    className="md-7 relative"
                    style={{ marginBottom: "-1.6rem" }}
                  >
                    <figure
                      className="absolute top-0 end-0 company-svg-3"
                      style={{ zIndex: 1 }}
                    >
                      <svg
                        style={{ opacity: ".4" }}
                    ...
                    <div className="card bg-dark text-start z-10 w-75 p-5 mb30 relative">
                      <span className="text-white goal-tagline">
                        Our Goal :{" "}
                      </span>
                      <h4 className="text-white goal-title mb-0 mt-3">
                    ...
                    <div className="card overflow-hidden p-0">
                      <img
                        src={`../../../resources/images/about/company-img-3.jpg`}
                        loading="lazy"
                        className="card-img"
                        alt="about-img"
                      />
                      <div className="absolute end-0 bottom-0 margin30 z-10">
                        <a
                          className="glightbox company-btn company-btn-white icons-center"
                        ...
                        >
                          <svg
                            ...
                            role="img"
                            focusable="false"
                            className="text-red-600 fa-fw fa-xl me-2"
                          >
          ...
          <div className="container">
            <div className="row g-4 items-center">
              <div className="lg-6">
                <div className="row">
                  <div className="md-6">
                    <div className="card know-card bg-grey p-5 mt40">
                      ...
                      <p className="mb-0">
                        Elevate your digital presence with our innovation-driven
                        approach
                      </p>
                    </div>
                    <div className="card know-card bg-grey p-5 mt40">
                      ...
                      <p className="mb-0">
                        At our digital agency, transparency isn't just a
                        buzzword
                      </p>
                    </div>
                  </div>
                  <div className="md-6">
                    <div className="card know-card bg-grey p-5 know-card-3">
                      <figure className="text-primary mb-3 flex-shrink-0">
                        <span>
                          <svg
                            width="50"
                    ...
                    <div className="card know-card bg-grey p-5 mt40">
                      ...
                      <p className="mb-0">
                        We believe that the best results are born from the
                        synergy of diverse
                      </p>
                    </div>
                  </div>
              ...
              <div className="lg-6 ps-xl-7">
                <h3 className="mb-4 common-title mt-5">
                  Know About
                  <span className="relative z-10 pl30 know-title">
                    {" "}
                    Rizqnet
                    <span
                      className="position-absolute industry-circle d-none d-md-block"
                ...
                <p className="common-desc">
                  At Rizqnet, we're not just in the business of digital
                  solutions; we're in the business of crafting digital success
                  stories. Founded on a passion for innovation and a commitment
                  to excellence, we've been at the forefront of the digital
                  landscape, helping businesses like yours thrive in the digital
                  age.
                </p>
                <p className="common-desc pt20">
                  Our story begins with a vision – a vision to transform the
                  digital experience for businesses of all sizes. Over the
                  years, we've evolved from a small startup to a dynamic digital
                  agency with a global footprint.
                </p>
                <p className="common-desc pt20 mb40">
                  To empower businesses to achieve their digital goals. We
                  believe that the digital realm offers boundless opportunities
                  for growth and connection, and we're here to guide you through
                ...
                <a href="#" className="icon-link ml-6">
                  Request a quote
                  <svg
                    width="1em"
                    height="1em"
        ...
        <section className="mt100 pt80 pb80 client-review-sec bg-dark text-white">
          <div className="container">
        ...
        <section className="our-location-sec">
          <div className="container pt100 pb100 bg-map">
            <div className="text-center">
              <h2 className="mb-4 common-title">
                We're expanding across World
              </h2>
              <p className="mb-6 common-desc">
                RizqNet customer support is available free of charge across
                World. Connection <br /> charges may vary depending on your
              ...
              <div className="row text-start mt30 justify-center">
                <div className="location-card margin20">
                  <div className="card border padding30">
                    <div className="flag mb20">
                      <img
                        className="flag-img rounded-circle"
                        src={"../../../resources/images/about/india-flag.svg"}
                        alt="india flag"
                      />
                    </div>
        ...
        {/* Faq Section Start */}
        <section className="faq-sec mb100">
          <div className="container">
            <h3 className="mb20 common-title">
              Frequently Asked{" "}
              <span className="relative z-10">
                {" "}
                Questions?
                <span className="position-absolute ml10 industry-circle">
                  <svg
                    width="188"
                    height="53"
                    viewBox="0 0 188 53"
            ...
            <div className="row">
              <div className="md-5 mt50">
                <div className="bg-light still-question rounded padding30 p-sm-5">
                  <h3>Still have a questions?</h3>
                  <p>
                    We'd be happy to help you with any questions you have!
                    Please let us know what you're looking for, and we'll do our
                    best to assist you.
                  </p>
                  <button className="mt30 mb10">
                    <a
                      href="#"
                      className="rounded-md px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm btn-secondary"
                    >
